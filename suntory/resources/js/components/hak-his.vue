                    ...
                    <article class="material-card Light-Green">
                        ...
                        <div class="mc-content">
                            <div class="img-container">
                                <img class="img-responsive card_img_style" src="">
                                <div class="mask"></div>
                                <img class="liquor" src="" alt="">
                                <img class="Medals" src="" alt="">
